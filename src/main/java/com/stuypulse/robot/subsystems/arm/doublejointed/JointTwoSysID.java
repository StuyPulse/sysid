                        ...
                        new SysIdRoutine.Mechanism(
                                ...
                                (log) -> {
                                    log.motor(doubleJointed.getName())
                                            .voltage(Units.Volts.of(doubleJointed.getJointTwoVoltage()))
                                            .angularPosition(Units.Radians.of(doubleJointed.getJointTwoPosition()))
                                            .angularVelocity(Units.RadiansPerSecond.of(doubleJointed.getJointTwoVelocity()));
                                },
                                this));
    }
