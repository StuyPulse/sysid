...
public class DoubleJointed extends SubsystemBase {
    ...
    public DoubleJointed() {
        ...
        jointOneController = new AnglePIDController(JointOne.kP, JointOne.kI, JointOne.kD)
        ...
        jointTwoController = new AnglePIDController(JointTwo.kP, JointTwo.kI, JointTwo.kD)
    ...
    public void periodic() {
        if (jointOneRoutine.get()) {
            ...
            jointTwo.setVoltage(jointTwoController.update(Angle.kZero, Angle.fromRadians(getJointTwoPosition())));
        }
        else if (jointTwoRoutine.get()) {
            jointOne.setVoltage(jointOneController.update(Angle.k90deg, Angle.fromRadians(getJointOnePosition())));
